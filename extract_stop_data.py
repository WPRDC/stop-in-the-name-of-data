...
class StopUseSchema(pl.BaseSchema):
    ...
    scheduled_trip_start_time_raw = fields.String(allow_none=True, dump_only=True) # Scheduled start times need to be strings since they can have values like 2410.
    scheduled_trip_start_time = fields.DateTime(allow_none=True)
    scheduled_stop_time_raw = fields.String(allow_none=True, dump_only=True) # Scheduled stop times need to be strings since they can have values like 2410.
